...
class LoRaWANsend(LoRa):
    ...
    def start(self):
        ...
        lorawan.create(MHDR.UNCONF_DATA_UP, {'devaddr': devaddr, 'fcnt': 1, 'data': list(map(ord, 'Lantern here!')) })
...
nwskey = [26, 177, 43, 132, 21, 161, 180, 132, 166, 78, 123, 159, 160, 181, 145, 61]
#appskey = [0x15, 0xF6, 0xF4, 0xD4, 0x2A, 0x95, 0xB0, 0x97, 0x53, 0x27, 0xB7, 0xC1, 0x45, 0x6E, 0xC5, 0x45]
appskey = [6, 137, 164, 43, 138, 122, 60, 129, 56, 114, 38, 8, 137, 38, 27, 165]
